    ...
    <section>
        <div>
            <div class="container py-4 py-xl-5">
                ...
                $api_course = json_decode(file_get_contents("$base_api_url/api/v1/courses/123"), true)[0];
                ...
                <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                    <?php
                        ...
                        $api_video = json_decode(file_get_contents("$base_api_url/api/v1/videos/123"), true);
